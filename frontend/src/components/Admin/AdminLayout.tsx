...
import { LayoutDashboard, Building2, BarChart3, LogOut, Menu, X } from 'lucide-react';
...
const AdminLayout = () => {
    ...
    const menuItems = [
        { path: '/admin/dashboard', icon: LayoutDashboard, label: 'Create School' },
        { path: '/admin/schools', icon: Building2, label: 'View Schools' },
